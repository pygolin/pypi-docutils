...
func init() {
	Code = πg.NewCode("<module>", "/usr/lib/python2.7/site-packages/docutils-0.16.data/scripts/rst2html.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		var πR *πg.Object
		_ = πR
		...
		Label1:
			...
			// line 20: description = ('Generates (X)HTML documents from standalone reStructuredText '
			πF.SetLineno(20)
			...
			// line 23: publish_cmdline(writer_name='html', description=description)
			πF.SetLineno(23)
